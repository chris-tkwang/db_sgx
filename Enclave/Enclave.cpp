...
const uint8_t COMMON_NODE_HEADER_SIZE = 2 * sizeof(uint8_t) + sizeof(uint32_t);

/*
 * Internal Node Header Layout
 */
const uint32_t INTERNAL_NODE_NUM_KEYS_SIZE = sizeof(uint32_t);
const uint32_t INTERNAL_NODE_NUM_KEYS_OFFSET = 2 * sizeof(uint8_t) + sizeof(uint32_t);
const uint32_t INTERNAL_NODE_RIGHT_CHILD_SIZE = sizeof(uint32_t);
const uint32_t INTERNAL_NODE_RIGHT_CHILD_OFFSET = 2 * sizeof(uint8_t) + 2 * sizeof(uint32_t);
const uint32_t INTERNAL_NODE_HEADER_SIZE = 2 * sizeof(uint8_t) + 3 * sizeof(uint32_t);
...
const uint32_t INTERNAL_NODE_CELL_SIZE = 2 * sizeof(uint32_t);
...
const uint32_t LEAF_NODE_NUM_CELLS_OFFSET = 2 * sizeof(uint8_t) + sizeof(uint32_t);
const uint32_t LEAF_NODE_NEXT_LEAF_SIZE = sizeof(uint32_t);
const uint32_t LEAF_NODE_NEXT_LEAF_OFFSET = 2 * sizeof(uint8_t) + 2 * sizeof(uint32_t);
const uint32_t LEAF_NODE_HEADER_SIZE = 2 * sizeof(uint8_t) + 3 * sizeof(uint32_t);
...
const uint32_t LEAF_NODE_SPACE_FOR_CELLS = 4096 - 2 * sizeof(uint8_t) - 3 * sizeof(uint32_t);

const uint32_t LEAF_NODE_MAX_CELLS = (4096 - 2 * sizeof(uint8_t) - 3 * sizeof(uint32_t)) / (sizeof(uint32_t) + size_of_attribute(Row, id) + size_of_attribute(Row, username) + size_of_attribute(Row, email));

const uint32_t LEAF_NODE_RIGHT_SPLIT_COUNT = ((4096 - 2 * sizeof(uint8_t) - 3 * sizeof(uint32_t)) / (sizeof(uint32_t) + size_of_attribute(Row, id) + size_of_attribute(Row, username) + size_of_attribute(Row, email)) + 1) / 2;

const uint32_t LEAF_NODE_LEFT_SPLIT_COUNT = ((4096 - 2 * sizeof(uint8_t) - 3 * sizeof(uint32_t)) / (sizeof(uint32_t) + size_of_attribute(Row, id) + size_of_attribute(Row, username) + size_of_attribute(Row, email)) + 1) - ((4096 - 2 * sizeof(uint8_t) - 3 * sizeof(uint32_t)) / (sizeof(uint32_t) + size_of_attribute(Row, id) + size_of_attribute(Row, username) + size_of_attribute(Row, email)) + 1) / 2;
...
void read_input(InputBuffer* input_buffer) {
  ssize_t bytes_read;
  ocall_getline(&bytes_read, input_buffer);
...
void pager_flush(Pager* pager, uint32_t page_num) {
  ...
  ocall_write(&bytes_written, pager->file_descriptor, pager->pages[page_num], PAGE_SIZE);
...
void db_close(Table* table) {
  ...
  int result;
  ocall_close(&result, pager->file_descriptor);
  if (result == -1) {
